...
class RemoveMemeInfoFromFavoriteUseCase @Inject constructor(
    private var memeRepository: MemeRepository
) {

    suspend operator fun invoke(memeInfo: MemeInfo) = memeRepository.removeMemeInfoFromFavorite(memeInfo)
}